...
- `bun test:endpoints` - Run consumer-style API sweep across all public/protected endpoints (auto-starts local server)
...
- `scripts/test-endpoints-with-server.sh` wraps endpoint tests by starting/stopping a local server automatically
