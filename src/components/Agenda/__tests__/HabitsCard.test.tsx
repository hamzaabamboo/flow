...
describe('HabitsCard', () => {
  ...
  it('should render loading state', () => {
    render(<HabitsCard habits={undefined} isLoading={true} isError={false} {...mockHandlers} />);
    expect(screen.getByText('Loading habits...')).toBeInTheDocument();
  });

  it('should render error state', () => {
    render(<HabitsCard habits={undefined} isLoading={false} isError={true} {...mockHandlers} />);
    expect(screen.getByText('Error loading habits')).toBeInTheDocument();
  });

  it('should render list of habits', () => {
    render(<HabitsCard habits={mockHabits} isLoading={false} isError={false} {...mockHandlers} />);
  ...
  it('should show empty state message', () => {
    render(<HabitsCard habits={[]} isLoading={false} isError={false} {...mockHandlers} />);
